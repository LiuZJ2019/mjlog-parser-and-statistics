...
void do_stats_algorithm(const MjlogGameContainer &container, const string &path)
{
    ...
    EXECUTE_STATS(stats_oya_richi_n_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_ron_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_tsumo_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_be_ron_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_be_tsumo_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_draw_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_oya_richi_n_ryuukyoku_gain, NUM_TO_MEAN_STD_SAMPLE)

    EXECUTE_STATS(stats_not_oya_richi_n_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_ron_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_tsumo_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_be_ron_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_be_tsumo_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_draw_gain, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_ryuukyoku_gain, NUM_TO_MEAN_STD_SAMPLE)
    ...
    EXECUTE_STATS(stats_oya_richi_n_be_tsumo_rate, NUM_TO_MEAN_STD_SAMPLE)
    ...
    EXECUTE_STATS(stats_not_oya_richi_n_be_tsumo_rate, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_draw_rate, NUM_TO_MEAN_STD_SAMPLE)
    EXECUTE_STATS(stats_not_oya_richi_n_ryuukyoku_rate, NUM_TO_MEAN_STD_SAMPLE)
